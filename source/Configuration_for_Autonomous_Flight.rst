...
* **Configure the mass of the UAV**
	Open ```~/mrs_workspace/src/uav_core/ros_packages/mrs_uav_managers/config/simulation/t650/mass.yaml``` and adjust the mass: ```uav_mass: 4.55 [kg]```. This ensures that the controllers and trackers that use mass (e.g., for feedforward actions) use the hardware mass.
